    ...
    " neocomplete {
        if count(g:spf13_bundle_groups, 'neocomplete')
            ...
            " Plugin key-mappings {
                ...
                if !exists('g:spf13_disable_clevertab')
                ...
                endif " exist(g:spf13_disable_clevertab)
            " }
...
" Functions {
    ...
    function! InitializeDirectories()
        ...
        if exists('g:spf13_consolidated_directory')
            if exists('g:spf13_no_directory_prefix')
                let common_dir = g:spf13_consolidated_directory
            else
